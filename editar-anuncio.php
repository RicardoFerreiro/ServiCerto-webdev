...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="descricao" rows="4" maxlength="200" placeholder="Máx: 200 carácteres"><?php echo $info['descricao']; ?></textarea>
		</div>
        <div class="form-group">
			<label for="Estado">Estado de Conservação:</label>
            <select name="estado" id="estado" class="form-control">
                <option value="1" <?php echo ($info['estado'] == 1)?'selected="selected"':''; ?>>Cambé</option>
                <option value="2" <?php echo ($info['estado'] == 2)?'selected="selected"':''; ?>>Londrina</option>
            </select>
		</div>
        <div class="form-group">
